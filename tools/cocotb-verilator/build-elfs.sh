...
# way bazel's coralnpu_v2_binary does (fastbuild: no -O; ITCM 8K / DTCM 32K
...
CFLAGS=(-march=rv32imf_zve32x_zicsr_zifencei_zbb -mabi=ilp32 -mcmodel=medany -Wall -Werror -Wno-unused-function -ffunction-sections -fdata-sections -DSKIP_HTIF_SYMBOLS)
